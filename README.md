...
<p align="center">
  <a href="https://wa.me/+13304089487?text=Hi+Bro--+I+Need+Help.+I+messaged+you+from+Starboy-Bot+Repo" target="_blank">
    <img alt="whatsapp" src="https://img.shields.io/badge/ Whatsapp -25D366?style=for-the-badge&logo=whatsapp&logoColor=white" />
  </a>
  <a aria-label="Starboy_Bot is free to use" href="https://github.com/shyambot/Starboy-Bot/blob/main/LICENCE" target="_blank">
    <img alt="License: GPL-3" src="https://badges.frapsoft.com/os/gpl/gpl.png?v=103)](https://opensource.org/licenses/GPL-3.0/" target="_blank" />
  </a>
  <a aria-label="Starboy_Bot is free to use" href="" target="_blank">
    <img alt="" src="https://img.shields.io/youtube/channel/subscribers/UCU071AMRqcd5mfTdCgJFwPg" target="_blank" />
  </a>

</p>
<p align="center"><img src="https://profile-counter.glitch.me/{shyambot}/count.svg" alt="shyambot :: Visitor's Count" /></p>
...
<p align="center"> Starboy Bot whatsapp bot uses
...
<p align="center">
  <a href="https://github.com/shyambot/Starboy-Bot"><b>Starboy-Bot</b></a> Support Deploy On...
</p>
...
## Deployment Methods
---
1.  ***Get `SESSION ID` by [`PAIRING CODE`](https://replit.com/@shyam7dx1/Starboy-BotPairingCode-1) code. And then `Go-to Whatapp>Three dots>Linked Devices`***
2.  ***Click [`FORK`](https://github.com/shyam/Starboy-Bot/fork) and `Star ⭐ Repository` if you Like that Bot.***
3.  ***Deploy FREE on `Codespace,`***
4.  ***Deploy on [`HEROKU`](https://suhail-web01.vercel.app/deploy.html)***
5.  ***Deploy on [`Replit`](https://suhail-web01.vercel.app/replit.html)***
...
```
mongodb+srv://Shyam:Starboy-Bot@cluster1.0tlyzhm.mongodb.net/?retryWrites=true&w=majority
```
---


- Star ⭐ repo if you like this bot.
- If any problem, then [`+13304089487`](https://wa.me/13304089487)
